...
// double multiply trys failed
// var add2 = function(number){ return number + 2; }
// var multiplyBy3 = function(number, callback){ return callback(number) * 3; }

// var pipe = function(func1,func2, func3){
//   return function(num){
//     return func2(func1(num), func3(num))
//   }
// };
...
// o(1)
 var greet = function(name, callback){ return 'hello ' + callback(name);}
 var exclaim = function(statement) { return statement.toUpperCase() + '!';}

var compose = function(exclaim, greet){
  return function(name){
    return greet(name, exclaim);
  }
};
